...
export const getUserSysMenu = req => {
  const loginMenu = [{ 'id': '1', 'parent_id': '0', 'menu_title': '权限管理', 'menu_name': 'permission', 'menu_cache': 1, 'menu_hide': 0, 'menu_icon': 'logo-buffer', 'menu_type': 3, 'menu_href': '', 'menu_component': '' },
    { 'id': '2', 'parent_id': '1', 'menu_title': '权限控制', 'menu_name': 'control', 'menu_cache': 1, 'menu_hide': 0, 'menu_icon': 'md-trending-up', 'menu_type': 3, 'menu_href': '', 'menu_component': 'Control' }
