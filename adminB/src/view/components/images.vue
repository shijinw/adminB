...
<template>
  <div ref="Image" style="position:relative;border: 1px dashed #9999;margin-bottom: 20px" v-if="show">
   <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="80">
  <Row style="margin-left:10px">
          <Col :span="12">
            <FormItem label="添加图片" prop="wx_img">
        ...
        <Modal title="图片预览" v-model="visible">
            ...
            <Button type="warning" class="handremove" @click="removes(id)">取消上传</Button>
