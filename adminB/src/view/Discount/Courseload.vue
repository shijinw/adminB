<template>
  <div>
    <Card>
      ...
      <Divider type="vertical" />
      <Input v-model="form.mobile" placeholder="电话号码" style="width: 200px; margin: 15px 15px;" />
      <Divider type="vertical" />

      <Button type="primary" @click="seach" style="margin-right: 10px;">请输入条件搜索课程卡</Button>
      <Button
