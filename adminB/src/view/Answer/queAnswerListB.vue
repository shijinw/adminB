    ...
    <Modal v-model="modal1"
      ...
      <div style="margin:0 auto;width:70rem">
        ...
        <div style="width:92%;border:1px solid #9999;margin:10px auto;border-radius: 20px;">
          ...
          <div class="content"
               style="width:92%" v-if="fromData.question_info.question_type===1?true:false"><strong class="example">选项答案 </strong>
          ...
          <div class="content"
               style="width:92%" v-if="fromData.question_info.question_type===1?true:false"><strong class="example">正确选项 ：{{fromData.question_info.true_options}}</strong></div>
          <div class="content"
