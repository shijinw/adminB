        ...
        <Form :model="fromData"
          ...
          <div style="margin:0 auto;width:60rem;">
            <div class="tuer">
              ...
              <div class="content"
                   style="width:95%"><strong class="example">知识点名称 :</strong> <span style="color:cornflowerblue;font-size:15px"
                      v-text="fromData.know_name"></span></div>
            </div>
            <div style="border:1px solid #999;border-radius: 20px;margin:10px 0">
              <div class="content"
                   style="width:95%"><strong class="example">题目内容 :</strong>
              ...
              <div class="content"
                   ...
                   style="width:95%"><strong class="example">选项答案 </strong>
              ...
              <div class="content"
                   style="width:95%"
                   v-if="fromData.question_info.question_type===1?true:false"><strong class="example">正确选项 ：{{fromData.question_info.true_options}}</strong></div>

              <div class="content"
                   style="width:95%"><strong class="example">题目难度 ：{{fromData.difficulty}}</strong></div>
              <div class="content"
                   style="width:95%;"><strong class="example"> 题目解析 ：</strong>
          ...
          <div style="border:1px solid #999;border-radius: 20px;margin:10px 0">
            <FormItem label="回复提问"
                      prop="reply_quiz"
                      style="margin-top:20px">
              <Input v-model="fromData.reply_quiz"
                     type="textarea"
                     placeholder="输入回复答案"
                     :rows="3"
                     style="width: 95%"
             ...
             <div class="Icontent" v-if="fromData.z_quiz">
              <p v-if="fromData.reply_image">回复图片 ：</p>
            <div
              class="demo"
          ...
          <div style="border:1px solid #999;border-radius: 20px;margin:10px 0"
            ...
            <div class="Icontent"
                 style="width:95%"
                 v-if="fromData.z_quiz_image">回复图片 ：
              <div class="demo"
          ...
          <div style="border:1px solid #999;border-radius: 20px;margin:10px 0"
            ...
            <FormItem label="追问回复"
              ...
              <Input v-model="fromData.z_reply_quiz"
                     type="textarea"
                     placeholder="输入追问回复"
                     :rows="3"
                     style="width: 100%" />
         ...
         <FormItem label="追问图片"
          ...
          <FormItem>
            <div style="text-align: center;">
              <Button type="success"
                      @click="handleSubmit"
                      style="margin-left: 8px;width:130px;height:45px;margin-right: 100px">提 交</Button>
            </div>
          </FormItem>
        </Form>
      </div>
...
<script>
import { queAnswerInfo, queReplyAnswer } from '@/api/Answer';
...
export default {
  data() {
    return {
      ...
      ruleValidate: {
        reply_quiz: [
          { required: true, validator: Fomat.Rules.Verifiy().ConRequired }
        ],
        z_reply_quiz: [
          { required: true, validator: Fomat.Rules.Verifiy().ConRequired }
        ],
  ...
  methods: {
    ...
    handleSubmit() {
      ...
      this.fromData.id = this.$route.query.id
          console.log(this.fromData.z_reply_image );
