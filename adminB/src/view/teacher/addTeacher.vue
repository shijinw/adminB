      ...
      <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="80">
        ...
        <FormItem>
          <div style="text-align: right;">
            ...
            <Button type="primary" @click="handleSubmit('formValidate')" style="margin-left: 8px">添 加 讲 师</Button>
          </div>
        </FormItem>
      </Form>
    </Card>
...
<script>
import { addTeacher, teacherTitleList } from '@/api/teacher'
    ...
    handleSubmit (name) {
      this.$refs[name].validate((valid) => {
        if (valid) {
          ...
          addTeacher(this.formValidate).then(res => {
